...
12025 if st<>0 then print"{red}error opening file for writing!":gosub 13000:return
...
12040 close 1
12045 if st<>0 then print"{red}error writing data to file!":gosub 13000:return
12050 print "game saved successfully."
12060 return
12100 rem *** load game ***
12110 print "loading game... please wait."
12120 open 1,8,2,"0:8bit.sav,s,r"
12130 if st<>0 then print"{red}save file not found or disk error!":gosub 13000:return
...
12145 if st<>0 and st<>64 then print"{red}error reading save file!":gosub 13000:return
12150 close 1
...
13030 close 15
13040 print "{red}disk error: ";em$;" (st=";st;")"
